...
### plutot qu`un dessin a l`ecran
 set term pdfcairo
 set output "courbe-toutes_versions-50var-3sat-2000.pdf" # le nom du fichier qui est engendre

set title "Comparaison de sat solvers, 50 variables, 3 SAT, 2000 tests"
set xlabel "Ratio nbClause/nbVar"
set ylabel "Temps d'execution"
set xtics border ("2" 0, "3" 1,"4" 2,"5" 3,"6" 4,"8" 5, "10" 6, "14" 7)
